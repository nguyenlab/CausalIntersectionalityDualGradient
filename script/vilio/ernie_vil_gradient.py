...
from model.vl_transformer_encoder import pre_process_layer
from model.vl_transformer_encoder_gradient import encoder
...
class ErnieVilModel(object):
    ...
    def get_pooled_output(self):
        ...
        text_cls_feat = fluid.layers.cast(x=text_cls_feat, dtype=self._emb_dtype)
        ...
        image_cls_feat = fluid.layers.cast(x=image_cls_feat, dtype=self._emb_dtype)
