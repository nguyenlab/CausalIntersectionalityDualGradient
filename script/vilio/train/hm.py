...
from entry_VLMo import ModelVLMo
    ...
    def __init__(self):
        ...
        if args.model == "X":
            ...
            config = {
                ...
                "num_gpus": 1,
                "num_nodes": 1,
                "load_path": "/vilio/ckpt/vlmo/vlmo_base_patch16_384_coco.pt",
                "num_workers": 8,
                "precision": 16,
            }
            self.model = ModelVLMo(config)
        else:
    ...
    if args.test is not None:
        ...
        for split in args.test.split(","):
            ...
            if "test" in split:
                hm.predict(
                    get_tuple(
                        split, bs=args.batch_size, shuffle=False, drop_last=False
                    ),
