...
class TextGenerationPipeline(Pipeline):
    ...
    def postprocess(
        ...
        records = []
        for sequence, attention in zip(generated_sequence, attentions):
            if return_type == ReturnType.TENSORS:
                record = {"generated_token_ids": sequence, "attention": attention}
                ...
                record = {"generated_text": all_text, "attentions": attention}
