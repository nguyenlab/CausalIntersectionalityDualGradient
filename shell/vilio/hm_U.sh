...
python hm.py --seed 86 --model U \
    ...
    --output /content/drive/MyDrive/vilio/export/U/attattr --extract_type attattr \
...
python hm.py --seed 86 --model U \
    --test dev_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 5 --tsv \
    --num_features 72 --num_pos 6 --loadfin $loadfin --exp U72 \
    --output /content/drive/MyDrive/vilio/export/U/attention --extract_type attention \
...
python hm.py --seed 86 --model U \
    --test dev_seen --lr 1e-5 --batchSize 8 --tr bert-large-cased --epochs 5 --tsv \
    --num_features 72 --num_pos 6 --loadfin $loadfin --exp U72 \
    --output /content/drive/MyDrive/vilio/export/U/gradient --extract_type gradient \
    --conf_modality txt --conf_unit_size 2 --preds_threshold .0 
